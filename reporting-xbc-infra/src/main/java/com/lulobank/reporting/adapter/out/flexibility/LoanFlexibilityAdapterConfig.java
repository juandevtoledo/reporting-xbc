...
@Configuration
public class LoanFlexibilityAdapterConfig {
    ...
    @Bean
    public LoanService getLoanService(FlexibilitySdk flexibilitySdk){
        return new LoanFlexibilityAdapter(flexibilitySdk);
    }
